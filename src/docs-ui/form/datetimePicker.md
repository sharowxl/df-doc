...
| format | 显示在输入框中的格式 | string | 见[日期格式](#/datePicker#ri-qi-ge-shi) | yyyy-MM-dd HH:mm:ss |
...
| value-format | 可选，绑定值的格式。不指定则绑定值为 Date 对象 | string | 见[日期格式](#/datePicker#ri-qi-ge-shi) | — |
| name | 原生属性 | string | — | — |
| unlink-panels | 在范围选择器里取消两个日期面板之间的联动 | boolean | — | false |
| prefix-icon | 自定义头部图标的类名 | string | — | df-icon-calendar |
