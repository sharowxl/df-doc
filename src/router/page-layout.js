...
import ChangeLog from '../docs-page-layout/changelog.md'

export const rootPathName = 'pageLayout'
...
const createBUiRouter = (moduleName, route) => {
  return {
    ...
    component: () => moduleName ? import('../docs-page-layout/' + moduleName.toLowerCase() + '/' + route.path + (route.filetype || '.md'))
      : import('../docs-page-layout/' + route.path + (route.filetype || '.md'))
  }
}
