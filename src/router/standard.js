...
import ChangeLog from '../docs-standard/changelog.md'

export const rootPathName = 'standard'
...
const createBUiRouter = (moduleName, route) => {
  return {
    ...
    component: () => moduleName ? import('../docs-standard/' + moduleName.toLowerCase() + '/' + route.path + (route.filetype || '.md'))
      : import('../docs-standard/' + route.path + (route.filetype || '.md'))
  }
}
